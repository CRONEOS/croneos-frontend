<template>
  <q-page padding class="constrain-page-width bg-white text-black">
    ...
    <p>When you schedule an action you have the option to pay gas. This gas is used to compensate the executer/miner of your job. Gas is completely optional.</p>
    ...
    <p>You can pay upfront by transfering a valid gas token to the contract with memo "deposit gas". Be sure there is only 1 space between the words. It's also possible to top up the gas deposits for an other account. Also you can use the UI to add and/or withdraw your deposits.</p>
